        ...
        >
            ...
            <div className="flex flex-col h-full">
                ...
                <div className="flex justify-between items-start w-full">
                    ...
                    {/* Right Side Branding */}
                    <div className="relative mt-2 md:mt-4 mr-0 md:mr-4 flex flex-col items-center scale-90 md:scale-100 origin-top-right">
                        <div className="w-14 h-10 md:w-20 md:h-16 relative opacity-40 mb-[-8px] md:mb-[-10px] z-10">
                            <Image
                                src="/LOGOMCD.svg"
                                alt="MCD Design Logo"
                                fill
                        ...
                        <div className="relative w-24 h-24 md:w-36 md:h-36 opacity-60">
                            <Image
                                src="/FACEMC.svg"
                ...
                {/* Bottom Bio */}
                <div className="mt-auto mb-6 md:mb-10 max-w-[580px] ml-1">
                    <div className="flex flex-col gap-3 md:gap-4 text-zinc-300 dark:text-[#cfd0d8] font-sans text-[12px] md:text-[14.5px] leading-[1.4] md:leading-[1.4] tracking-normal font-[400]">
